...
public class Review extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.jelanidenis.courseq.R.layout.review);
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if (!task.isSuccessful()) {
                            ...
                            Toast.makeText(Review.this, com.jelanidenis.courseq.R.string.auth_failed,
        ...
        ValueEventListener CoursesListener = new ValueEventListener() {
            ...
            public void onCancelled(DatabaseError databaseError) {
                ...
                Toast.makeText(Review.this, "Failed to load courses.",
                        Toast.LENGTH_SHORT).show();
            }
        };
    ...
    private boolean setUpUI() {
        ...
        search_list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                */
                ...
                Log.i(TAG, "course has been made" + course);
            }
        });
        ...
        NextButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (course.equals("")) {
                    Toast.makeText(Review.this, com.jelanidenis.courseq.R.string.course_required,
                            Toast.LENGTH_SHORT).show();
                }
                else {
                    Proceed();
