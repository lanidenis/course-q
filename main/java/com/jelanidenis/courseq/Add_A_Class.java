...
public class Add_A_Class extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.jelanidenis.courseq.R.layout.add_a_class);
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if (!task.isSuccessful()) {
                            ...
                            Toast.makeText(Add_A_Class.this, com.jelanidenis.courseq.R.string.auth_failed,
    ...
    private boolean setUpUI() {
        ...
        NextButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (course.equals("")) {
                    Toast.makeText(Add_A_Class.this, com.jelanidenis.courseq.R.string.course_required,
                            Toast.LENGTH_SHORT).show();
                }
                else {
                    Proceed();
